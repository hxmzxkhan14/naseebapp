  ...
  const securitySettings = [
    {
      ...
      onPress: () => router.push('/(screens)/settings/privacy-security/two-factor-auth'),
    },
    {
      icon: 'shield-outline',
      title: 'Blocked Users',
      subtitle: 'Manage your blocked users list',
      onPress: () => router.push('/(screens)/settings/privacy-security/blocked-users'),
    },
    {
      icon: 'notifications-off-outline',
      title: 'Report & Safety',
      subtitle: 'Report issues and get help',
      onPress: () => router.push('/(screens)/settings/privacy-security/report-safety'),
    },
  ];
