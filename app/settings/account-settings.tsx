...
export default function AccountSettingsScreen() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      onPress: () => router.push('/settings/account-settings/profile-photos'),
    },
    {
      icon: 'location-outline',
      title: 'Location Settings',
      subtitle: 'Control your location visibility and preferences',
      onPress: () => router.push('/settings/account-settings/location-settings'),
    },
    {
      icon: 'language-outline',
      title: 'Language & Region',
      subtitle: 'Change app language and regional settings',
      onPress: () => router.push('/settings/account-settings/language-region'),
    },
    {
      icon: 'card-outline',
    ...
    },
    {
      ...
      onPress: () => router.push('/settings/account-settings/data-privacy'),
    },
  ];
